...
Write-Host "Note: Some features requiring external files may not work in memory-only mode." -ForegroundColor Yellow
"@

Invoke-Expression $mainModuleContent

# Summary
Write-Host "`n=== Loading Summary ===" -ForegroundColor Yellow
...
Write-Host "  # ... other AADInternals commands" -ForegroundColor Gray
